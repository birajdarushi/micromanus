...
export default function LoginPage() {
  ...
  async function signIn(provider: "google" | "github") {
    setLoading(provider);
    captureEvent("login_initiated", { provider });
      ...
      <div className="relative w-full max-w-sm text-center animate-in fade-in duration-300">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 rounded-lg bg-zinc-50 text-zinc-900 py-2.5 font-medium hover:bg-white transition-colors disabled:opacity-60 focus-visible:ring-2 focus-visible:ring-accent-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 focus-visible:outline-none"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 rounded-lg bg-zinc-900 text-zinc-100 py-2.5 font-medium hover:bg-zinc-800 transition-colors border border-zinc-800 disabled:opacity-60 focus-visible:ring-2 focus-visible:ring-accent-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 focus-visible:outline-none"
          >
